...
<table border="0" width="640" cellspacing="1" cellpadding="3">
<tr>
...
<tr>
<td width="100%" style="text-align:justify">
<font style="font-family: Verdana, Arial, Helvetica, sans-serif;	color:#000; font-size:14;">{short-story}</font></td>
</tr>
<tr>
<td width="100%">
<table border="0" style="border-top: 1px dotted #f2f3f3" width="408" cellspacing="0">
<tr>
<td width="220"><i><font style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size:11;	color:black;">{date} by {author}</font></i><br> </td><td width="168" ><div align=right>
<font style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size:11;">[full-link]Read More ...[/full-link]    <br> 
</div>
</td>
</tr>
</table>
